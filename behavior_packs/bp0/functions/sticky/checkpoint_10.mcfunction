...
execute @a[r=8,tag=!check_10] ~ ~ ~ tag @e[type=cyd:sticky_lever_exit] add checkpoint
execute @a[r=8,tag=!check_10] ~ ~ ~ tag @s add check_10
execute @a[r=8,tag=check_10] ~ ~ ~ spawnpoint @s ~ ~ ~
execute @a[r=8,tag=check_11] ~ ~ ~ tag @s remove check_11