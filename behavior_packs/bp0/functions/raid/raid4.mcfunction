...
execute @p[tag=player1,tag=!completedmoon,tag=!completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_1 ~1 ~ ~
execute @p[tag=player1,tag=!completedmoon,tag=!completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_2 ~1 ~ ~2

#pool 2
execute @p[tag=player1,tag=!completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_3 ~ ~ ~1
execute @p[tag=player1,tag=!completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_1 ~1 ~ ~
execute @p[tag=player1,tag=!completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_2 ~1 ~ ~2
execute @p[tag=player1,tag=!completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_1 ~2 ~ ~1
execute @p[tag=player1,tag=!completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_2 ~-1 ~ ~

#pool 3
execute @p[tag=player1,tag=completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_mutant_minion ~ ~ ~1
execute @p[tag=player1,tag=completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_mutant_minion ~1 ~ ~
execute @p[tag=player1,tag=completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_mutant_minion ~1 ~ ~2
execute @p[tag=player1,tag=completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_mutant_minion ~2 ~ ~1
execute @p[tag=player1,tag=completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_mutant_minion ~ ~ ~-1
execute @p[tag=player1,tag=completedmoon,tag=completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_mutant_minion ~-1 ~ ~
