...
execute @p[tag=player1,tag=!completedmoon,tag=!completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_1 ~-1 ~ ~2
execute @p[tag=player1,tag=!completedmoon,tag=!completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_2 ~-2 ~ ~1
execute @p[tag=player1,tag=!completedmoon,tag=!completedkun] ~ ~ ~ execute @e[tag=activeraid,c=1] ~ ~ ~ summon cyd:world_henchman_1 ~-1 ~ ~-1
