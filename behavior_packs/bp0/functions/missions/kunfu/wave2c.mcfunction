...
fill -202 24 1841 -200 24 1841 redstone_block
...
summon cyd:kun_wk_henchman_1 -195 30 1834
summon cyd:kun_wk_henchman_2 -195 30 1831

summon cyd:kun_wk_henchman_2 -195 30 1852
