...
execute @s ^ ^ ^ detect ^ ^2 ^4 air 0 tag @s[tag=!four,tag=three,tag=two,tag=one] add four
...
execute @s ^ ^ ^ detect ^ ^2 ^5 air 0 tag @s[tag=!five,tag=four,tag=three,tag=two,tag=one] add five
#execute @s ^ ^ ^ detect ^ ^ ^3 stone 1 tag @s[tag=four] remove four
...
execute @s ^ ^ ^ detect ^ ^2 ^6 air 0 tag @s[tag=!six,tag=five,tag=four,tag=three,tag=two,tag=one] add six
...
execute @s ^ ^ ^ detect ^ ^2 ^7 air 0 tag @s[tag=!seven,tag=six,tag=five,tag=four,tag=three,tag=two,tag=one] add seven
